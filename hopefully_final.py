...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.page1ForControls.setObjectName("page")
        ...
        self.XaxisOptions = QtWidgets.QWidget(self.page1ForControls)
        self.XaxisOptions.setGeometry(QtCore.QRect(0, 0, 131, 89))
        self.XaxisOptions.setObjectName("widget")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.XaxisOptions)
        self.verticalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.NumChunksLabel = QtWidgets.QLabel(self.XaxisOptions)
        font = QtGui.QFont()
        font.setFamily("Leelawadee")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.NumChunksLabel.setObjectName("label")
        self.verticalLayout_3.addWidget(self.NumChunksLabel)
        self.OneChunkRadioButton = QtWidgets.QRadioButton(self.XaxisOptions)
        self.OneChunkRadioButton.setObjectName("OneChunkRadioButton")
        self.verticalLayout_3.addWidget(self.OneChunkRadioButton)
        self.MultipleChunksRadioButton = QtWidgets.QRadioButton(self.XaxisOptions)
        ...
        self.NumberChunksSpinBox = QtWidgets.QSpinBox(self.XaxisOptions)
        ...
        self.OrderOfInterpolationLabel.setObjectName("label_6")
     ...
     #   self.InterPolationOrderSlider.setPageStep(9)
        ...
        self.XaxisOptions1 = QtWidgets.QWidget(self.page2ForControls)
        self.XaxisOptions1.setGeometry(QtCore.QRect(0, 10, 121, 42))
        self.XaxisOptions1.setObjectName("widget1")
        self.verticalLayout_6 = QtWidgets.QVBoxLayout(self.XaxisOptions1)
        self.verticalLayout_6.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_6.setObjectName("verticalLayout_6")
        self.label_7 = QtWidgets.QLabel(self.XaxisOptions1)
        font = QtGui.QFont()
        font.setFamily("Leelawadee")
        font.setPointSize(9)
        font.setBold(True)
        ...
        self.ChunkNumberComboBox = QtWidgets.QComboBox(self.XaxisOptions1)
        self.ChunkNumberComboBox.setObjectName("ChunkNumberComboBox")
        self.verticalLayout_6.addWidget(self.ChunkNumberComboBox)
        self.XaxisOptions2 = QtWidgets.QWidget(self.page2ForControls)
        self.XaxisOptions2.setGeometry(QtCore.QRect(0, 60, 122, 108))
        self.XaxisOptions2.setObjectName("widget2")
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.XaxisOptions2)
        self.verticalLayout_4.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.TypeOfInterpolationLabel = QtWidgets.QLabel(self.XaxisOptions2)
        font = QtGui.QFont()
        font.setFamily("Leelawadee")
        font.setPointSize(9)
        font.setBold(True)
        ...
        self.verticalLayout_4.addWidget(self.TypeOfInterpolationLabel)
        self.LinearInterpRadioBtn = QtWidgets.QRadioButton(self.XaxisOptions2)
        self.LinearInterpRadioBtn.setObjectName("LinearInterpRadioBtn")
        self.verticalLayout_4.addWidget(self.LinearInterpRadioBtn)
        self.PolynomialInterpRadioBtn = QtWidgets.QRadioButton(self.XaxisOptions2)
        ...
        self.ErrorMappingCalcContainerWidget.setObjectName("widget_3")
        ...
        self.XaxisLabel.setObjectName("label_8")
        ...
        self.YaxisLabel.setObjectName("label_9")
        self.XaxisOptions3 = QtWidgets.QWidget(self.ErrorMappingCalcContainerWidget)
        self.XaxisOptions3.setGeometry(QtCore.QRect(70, 80, 221, 31))
        self.XaxisOptions3.setObjectName("widget3")
        self.xAxisNumChunksRadioBtn = QtWidgets.QRadioButton(self.XaxisOptions3)
        ...
        self.xAxisInterpolationRadioBtn = QtWidgets.QRadioButton(self.XaxisOptions3)
        ...
        self.XaxisOptions_2 = QtWidgets.QWidget(self.ErrorMappingCalcContainerWidget)
        self.XaxisOptions_2.setGeometry(QtCore.QRect(70, 110, 221, 31))
        self.XaxisOptions_2.setObjectName("widget_2")
        self.yAxisNumChunksRadioBtn = QtWidgets.QRadioButton(self.XaxisOptions_2)
        ...
        self.yAxisInterpolationRadioBtn = QtWidgets.QRadioButton(self.XaxisOptions_2)
        ...
        self.label_12 = QLabel(self.ErrorMappingCalcContainerWidget)
        ...
        self.verticalLayout_5.addWidget(self.ErrorMappingCalcContainerWidget)
