...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        #self.figure_errormap = QtWidgets.QWidget(self.widget_3)
        #self.figure_errormap.setObjectName("figure_errormap")

        #self.figure_errormap=Figure(figsize=(2,2),dpi=100)
        #self.axes_errormap=self.figure_errormap.add_subplot()
        #self.axesy_errormap=self.figure_errormap.add_subplot()
        #self.canvas_maingraph=FigureCanvas(self.figure_errormap)
      ...
      #  self.verticalLayout.addWidget(self.canvas_maingraph)
        ...
        self.ErrorMappingGraph.setObjectName(u"ErrorMappingGraph")
        self.verticalLayout.addWidget(self.ErrorMappingLabel)

        self.label_13 = QLabel(self.GraphingContainer)
        self.label_13.setObjectName(u"label_13")
        #self.label_13.setPixmap(QPixmap(u"../final/violin.jfif"))
...
#        self.CurveFittingGraph.
    ...
    def errorMap(self, errorVals):
      ...
      #  qimage = QtGui.QImage.rgbSwapped(QtGui.QImage(buf, size[0], size[1],QtGui.QImage.Format_ARGB32))
       ...
       # self.label_13.setPixmap(qpixmap)
        #self.ErrorMappingGraph.setCellWidget(self.Chunkorder-1,0,label)
        #self.canv.draw()
        #plt.show()
    ...
    def errorMappingCalcChunk(self, calculatedChunk, actaulChunk, axEnable):
        ...
        if(axEnable ==0):
            ...
            self.label_13.setMaximumWidth(400)
            self.label_13.setPixmap(QPixmap(u"../final/Capture1.jpg"))
            self.label_13.setScaledContents(True)
            #print(errsAvg)
            #print(errsAvgChunk)
